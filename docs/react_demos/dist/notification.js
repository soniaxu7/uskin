...
/***/ function(module, exports) {
	...
	ReactDOM.render(React.createElement(
	  'div',
	  null,
	  React.createElement(Notification, { title: text[0].title, content: text[0].content }),
	  React.createElement(Notification, { title: text[0].title, content: text[0].content, type: 'info' }),
	  React.createElement(Notification, { title: text[0].title, content: text[0].content, type: 'success' }),
